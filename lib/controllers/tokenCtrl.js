...
module.exports= function(Token){
    ...
    var getReport = (req,res)=>{
        ...
        var startmonth = moment(endmonth).subtract(3, "months");
        var start = moment(startmonth).startOf('month');
    ...
    var deleteReports = (req, res)=>{
        ...
        fs.readdir(directory, (err, files) => {
            ...
            res.status(200).send({ success:true, message:"housecleaning complete"});
        });

    };

    var testEmail = (req,res)=>{
