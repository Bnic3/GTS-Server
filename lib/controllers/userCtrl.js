...
var userCtrl= function(User,Estate){
   ...
   /* const BaseURL = "http://localhost:3000";*/
    ...
    var csvMultiple = (req, res)=>{
        ...
        var numbers= input.dataObj;
        console.log(numbers);
        var csv_eid= numbers[0].eid;
        console.log(csv_eid);
    ...
    var OTPLogin = (req, res)=>{
        ...
        .then((success)=>{
            ...
            .then((success)=>{
             ...
             var smsurl = `${smsURL}/api/?username=${username}&password=${password}&message=${message}&sender=GTS&mobiles=${mobile}`;
                return axios.get(smsurl);



            })
            .then((success)=>{
                console.log("In sms axios");
               /* console.log(success);*/
                ...
                return res.status(200).send({
                    ...
                    data: {ename:estInfo[0].e_name ,
                        firebase_token:estInfo[0].firebase_token,
                ...
                console.log("i am in sms failure");
                throw new Error(failure);
            })
        .catch(function(err){
                console.error(err);
