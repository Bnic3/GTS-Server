    ...
    if(process.env.ENV =="prod"){ BaseURL = process.env.BASEURL;}
     ...
     var createEstate= (req,res)=>{
                    ...
                    est.sub_token= jwt.sign(input,"supersecret", {
                        expiresIn: "30 days" // expires in 3 minute
                    });
                    ...
                    est.save()
                        ...
                        .then((response)=>{
                            ...
                            return res.status(200).send({ success:true, message:"Estate and Admin has been created(30 days TRIAL)", data: estateObj.eid})},(failure)=>{
